...
<?php if(!empty($order)) { ?>
    ...
    <input type='hidden'
							...
							name='notify_url'
							value='http://localhost:8080/php-shopping-cart-with-payment-gateway-integration/notify.php'> <input
							type='hidden' name='return'
							value='http://localhost:8080/php-shopping-cart-with-payment-gateway-integration/response.php'> <input type="hidden"
